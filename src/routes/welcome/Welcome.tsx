    ...
    return (
        ...
        <div className="textBody">
            <div className="section1 reveal2" id="about">
                ...
                <p>We are a mental health service organization that our purpose is to help individuals with their mental health. Our Vison is to destigmatize therapy among Americans, and make therapy more affordable and easy to access.​

​

Our mission is to be a top provider of services that facilitates the matching of mental health patients to therapists at the most affordable cost</p>
